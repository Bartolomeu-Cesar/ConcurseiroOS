...
import { loadFlashcardsToday, revealAnswer, reviewFlashcard, addFlashcard, loadAllFlashcards, toggleFlashGroup, iniciarSessaoFlash, sessaoNext, deleteFlashcard, openFlashEditModal, closeFlashEditModal, saveFlashEdit, initFlashcards, toggleGenerationMode, setFlashConfidence, startBossBattle, bossBattleReview, startAudioMode, stopAudioMode, pauseAudioMode, skipAudioCard, startCommutingMode, stopCommutingMode, loadLeitnerBoxes, startFlashByMateria, skipElaboration, saveElaboration, openBrainDump, submitBrainDump, closeBrainDump, continueAfterChunk, saveMnemonic, skipMnemonic, saveSessionSummary, startExamMode, stopExamMode, dismissHypercorrection, skipMicroBreak, revealNextSegment, clozeInserirLacuna, clozePreview, criarCloze, customStudy, customStudyMateria, undoLastReview } from './modules/flashcards.js';
...
Object.assign(window, {
  ...
  goToEditalItem,
  // PDFs
  load, exportProgress, importProgress, uploadPdf, toggleOrgMode, criarPastaVirtual, toggleModoLocal, sincronizar,
  // Edital
  ...
  clozeInserirLacuna, clozePreview, criarCloze,
  customStudy, customStudyMateria, undoLastReview,
  // Súmulas
