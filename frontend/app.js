...
async function responderQuestaoDia(letra) {
    ...
    document.querySelectorAll('.qdia-alt').forEach(btn => {
        ...
        if (btnLetra === q.resposta_correta) {
    ...
    fb.innerHTML = `<strong>${acertou ? '✓ Correto!' : '✗ Errado! Resposta: ' + q.resposta_correta}</strong>
        ...
        <br><button onclick="qDiaIdx++;showQuestaoDia();" style="margin-top:8px;background:#89b4fa;color:#1e1e2e;border:none;border-radius:6px;padding:6px 14px;font-weight:600;cursor:pointer;">Próxima →</button>`;
